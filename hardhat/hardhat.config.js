...
module.exports = {
  ...
  networks: {
    ...
    ethereum: {
      url: "https://eth-mainnet.g.alchemy.com/v2/1JeARAP6tJKmAvtH72NWNkiYN0JS-k8m",
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    goerli: {
      url: "https://eth-goerli.g.alchemy.com/v2/VfSREJBwtiCMQvwk7eKRJoi3qHDwueb6", 
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    optimism: {
      url: "https://opt-mainnet.g.alchemy.com/v2/CLuR59QFS6L_jH-aMwiOzRZicl5rXrLK", 
      accounts: {
        mnemonic: mnemonic(),
      },
    },
